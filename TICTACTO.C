/*
  ...
  the C standard and not available in Dev-C++ or gcc by default.
  Please let me know if you find and error or if you have any questions.
  I have also attached libconio.a, myconio.cpp and myconio.h
  Enjoy!
*/
...
int main()
{
  ...
  do{
   ...
   textbackground(WHITE); textcolor(GREEN); //Set the specified background and textcolor
